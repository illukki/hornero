#!/bin/bash
#####################################
# Compilation of packages for ALL	#
...
do
	...
	then
		...
		then
			...
			if [ -e packages/i686/$PKGX2.tbz2 ]
			then
				clear
				echo "------------------------------------------------------------------"
				echo "Package: $PKGX ($PKGX2)"
